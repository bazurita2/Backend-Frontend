<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/_Layout.Master" AutoEventWireup="true" CodeBehind="AsientoManualView.aspx.cs" Inherits="Cliente.Views.Contabilidad.AsientoManualView" %>
            ...
            <div class="col-sm">
                ...
                <div class="mb-3">
                    <asp:GridView ID="grdDetalles" runat="server" AutoGenerateColumns="False" CssClass="table table-striped"
                        DataKeyNames="iddetalle,idcuenta,debedetalle,haberdetalle"
                        ...
                        <Columns>                            
                            <asp:BoundField DataField="iddetalle" HeaderText="ID" SortExpression="iddetalle" visible="false"/>
