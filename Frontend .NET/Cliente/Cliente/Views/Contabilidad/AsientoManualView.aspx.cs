...
namespace Cliente.Views.Contabilidad
{
    public partial class AsientoManualView : System.Web.UI.Page
    {
        ...
        private static DataTable dtCuenta;
        ...
        private void cargarCombos()
        {
            String value;
            String nombre;
             dtCuenta = objBllCuenta.listar();
            DataView dvCuentas = dtCuenta.DefaultView;
        ...
        {
            //llenarTabla();
            grdDatos.DataSource = objBll.getByFechaDataTable(
        ...
        {
            List<AsientoModel> lista = objBll.listarToList();
        ...
        private void ActualizarDetalles()
        {
            ...
            String idasiento = grdDatos.SelectedDataKey["idasiento"].ToString();
            for (int i = 0; i < dtDetalle.Rows.Count; i++)
            {
                DetalleAsientoModel obj = new DetalleAsientoModel();
                obj.idcuenta = dtDetalle.Rows[i]["idcuenta"].ToString();
        ...
        protected void grdDatos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            dtDetalle = objDetalleBll.getByIdCabecera(grdDatos.SelectedDataKey["idasiento"].ToString());
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            {
                AsientoModel a = new AsientoModel();
                a.idasiento = grdDatos.SelectedDataKey["idasiento"].ToString();
                a.fechaasiento = DateTime.Parse(fechaAsiento.SelectedDate.ToString());
                a.observacionasiento = observacionAsiento.Text.Trim();
                objBll.actualizar(a);
        ...
        {
            string id = grdDatos.SelectedDataKey["idasiento"].ToString();
            eliminarDetalles(id);
            objBll.eliminar(id);
            llenarTabla();
            limpiarFormulario();
        ...
        protected void btnQuitarDetalle_Click(object sender, EventArgs e)
        {
            ...
            {
                if (item["iddetalle"].ToString().Equals(grdDetalles.SelectedDataKey["iddetalle"].ToString()))
