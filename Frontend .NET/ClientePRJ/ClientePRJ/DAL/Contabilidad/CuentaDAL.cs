    ...
    public class CuentaDAL
    {
        ...
        public bool insertar(CuentaModel obj)
        {
            using (var client = new HttpClient())
            {
                ...
                var postTask = client.PostAsync("Cuenta/guardarCuenta", stringContent);
                postTask.Wait();
        ...
        public bool actualizar(CuentaModel obj)
        {
            using (var client = new HttpClient())
            {
                ...
                var postTask = client.PutAsync("Cuenta/actualizarCuenta", stringContent);
                postTask.Wait();
        ...
        public bool eliminar(int id)
        {
            ...
            {
                client.BaseAddress = new Uri(chain);
                var deleteTask = client.DeleteAsync("Cuenta/eliminarCuenta/?id=" + id);
                deleteTask.Wait();
        ...
        public DataTable getByNombreDataTable(String nombre)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                client.BaseAddress = new Uri(chain);
                var responseTask = client.GetAsync("Cuenta/CuentaByNombre?nombre=" + nombre);
                responseTask.Wait();
        ...
        public DataTable getByIdDataTable(int id)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                client.BaseAddress = new Uri(chain);
                var responseTask = client.GetAsync("Cuenta/CuentaById?id=" + id);
                responseTask.Wait();
